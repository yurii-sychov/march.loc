    ...
    Plugin.prototype = {
        init: function (options) {
            ...
            for (i = 0; i < bins.length; i++) {
                ...
                var binHtml = "<div class='tooltipbar' style='float:left!important;width:" + widthPerBin + "%;'>" +
                    toolTipHtml +
            ...
            $("#" + sliderName).slider({
                ...
                slide: function (event, ui) {
					...
					updateHotelsListFromHistogramSlider(ui.values[0], ui.values[1]); // callback function to hotels.js
					//$("#" + sliderName + "-from-value").val(ui.values[0]);
					//$("#" + sliderName + "-to-value").val(ui.values[1]);
            ...
            if (self.options.showSelectedRange){
				//$("#" + sliderName).after("<input type='text' id='" + sliderName + "-to-value' />");
				//$("#" + sliderName).after("<input type='text' id='" + sliderName + "-from-value' />");

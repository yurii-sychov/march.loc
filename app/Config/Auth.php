...
class Auth extends ShieldAuth
{
    ...
    public array $views = [
        ...
        'layout'                      => '\App\Views\default\auth\layout',
        'action_email_2fa'            => '\CodeIgniter\Shield\Views\email_2fa_show',
        'action_email_2fa_verify'     => '\CodeIgniter\Shield\Views\email_2fa_verify',
        'action_email_2fa_email'      => '\CodeIgniter\Shield\Views\Email\email_2fa_email',
        'action_email_activate_show'  => '\App\Views\default\auth\email_activate_show',
        'action_email_activate_email' => '\App\Views\default\auth\Email\email_activate_email', 
        'magic-link-login'            => '\App\Views\default\auth\magic_link_form',
        'magic-link-message'          => '\App\Views\default\auth\magic_link_message',
        'magic-link-email'            => '\App\Views\default\auth\Email\magic_link_email',
        'action_sms_2fa'              => '\App\Views\default\auth\login_2fa_show',
    ];
    ...
    public array $redirects = [
        'register' => '/accounts/new-password',
        'register2FA' => '/accounts/add-phone',
        'login'    => '/dashboard/index',
        'logout'   => '/accounts/login',
        'permission_denied' => '/',
        'group_denied'      => '/',
        '2FA_set_redirect' => '/accounts/confirm-2fa',
        'invite' => '/accounts/invite-new-password',
        'invite2FA' => '/accounts/invite-add-phone',
    ];
    ...
    public array $actions = [
        'register' => 'CodeIgniter\Shield\Authentication\Actions\EmailActivator',
        //'register' => null, 
        'login'    => ( $this->enable2FA!=='true' ? null : 'App\Modules\User\Actions\Sms2FA'),
    ];*/
    ...
    public function __construct()
    {
        ...
        $this->actions = [
            'register' => 'CodeIgniter\Shield\Authentication\Actions\EmailActivator',
            'login' => getenv('enable2FA') === 'true' ? 'App\Modules\User\Actions\Sms2FA' : null,
        ];
    }

   // public $enable2FA = getenv('enable2FA'); 
     ...
     */
    public int $magicLinkLifetime = WEEK;
     ...
     */
    public string $userProvider = 'App\Modules\User\Models\UserModel';
    ...
    {
        $enable2FA = getenv('enable2FA');

       // dd($enable2FA);
        
        if($enable2FA==='true')
            $url = setting('Auth.redirects')['register2FA'];
        else 
     ...
     */
    public function inviteRedirect(): string
    {
        $enable2FA = getenv('enable2FA');
       ...
       // dd($enable2FA);
        ...
        if($enable2FA==='true')
            $url = setting('Auth.redirects')['invite2FA'];
        else 
            $url = setting('Auth.redirects')['invite'];
     ...
     */
    public function redirectSet2FA(): string
    {
        $url = setting('Auth.redirects')['2FA_set_redirect'];
